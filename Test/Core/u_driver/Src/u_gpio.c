...
void u_gpio_Init_externalInterrupt()
{
	...
	/**/
	LL_GPIO_SetPinPull(DigitalInput0_GPIO_Port, DigitalInput0_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinPull(DigitalInput1_GPIO_Port, DigitalInput1_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinPull(DigitalInput6_GPIO_Port, DigitalInput6_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinPull(DigitalInput3_GPIO_Port, DigitalInput3_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinPull(DigitalInput2_GPIO_Port, DigitalInput2_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinPull(DigitalInput5_GPIO_Port, DigitalInput5_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinPull(DigitalInput4_GPIO_Port, DigitalInput4_Pin, LL_GPIO_PULL_DOWN);

	/**/
	LL_GPIO_SetPinMode(DigitalInput0_GPIO_Port, DigitalInput0_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(DigitalInput1_GPIO_Port, DigitalInput1_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(DigitalInput6_GPIO_Port, DigitalInput6_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(DigitalInput3_GPIO_Port, DigitalInput3_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(DigitalInput2_GPIO_Port, DigitalInput2_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(DigitalInput5_GPIO_Port, DigitalInput5_Pin, LL_GPIO_MODE_INPUT);

	/**/
	LL_GPIO_SetPinMode(DigitalInput4_GPIO_Port, DigitalInput4_Pin, LL_GPIO_MODE_INPUT);
