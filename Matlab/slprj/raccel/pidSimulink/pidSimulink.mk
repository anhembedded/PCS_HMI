...
MODEL               = pidSimulink
MODULES             = rt_logging.c pidSimulink.c pidSimulink_capi.c pidSimulink_data.c pidSimulink_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
MAKEFILE            = pidSimulink.mk
...
MASTER_ANCHOR_DIR   = 
START_DIR           = C:/Project/PCS_HMI/Matlab
...
PCMATLABROOT        = C:\\Program Files\\Polyspace\\R2019b
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/pidSimulink \
...
raccel_main_new.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\raccel/raccel_main_new.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\raccel/raccel_main_new.c

raccel_sup.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\raccel/raccel_sup.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\raccel/raccel_sup.c

raccel_mat.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\raccel/raccel_mat.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\raccel/raccel_mat.c

simulink_solver_api.obj : C:\Program\ Files\Polyspace\R2019b\simulink\include/simulink_solver_api.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\simulink\include/simulink_solver_api.c

raccel_utils.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\src\rapid/raccel_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\src\rapid/raccel_utils.c

common_utils.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\src\rapid/common_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\src\rapid/common_utils.c

ext_svr.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/ext_svr.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/ext_svr.c

updown.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/updown.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/updown.c

ext_work.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/ext_work.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/ext_work.c

rtiostream_interface.obj : C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/rtiostream_interface.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\rtw\c\src\ext_mode\common/rtiostream_interface.c

rtiostream_tcpip.obj : C:\Program\ Files\Polyspace\R2019b\toolbox\coder\rtiostream\src\rtiostreamtcpip/rtiostream_tcpip.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\toolbox\coder\rtiostream\src\rtiostreamtcpip/rtiostream_tcpip.c

rtiostream_utils.obj : C:\Program\ Files\Polyspace\R2019b\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2019b\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
