...
#ifndef INCLUDE_GUI_MODEL_PID
#define INCLUDE_GUI_MODEL_PID
...
extern unsigned long pidTick;
void pidTickUpdate(unsigned long tickValue);
unsigned long simGetTick();
#define GetTime() simGetTick()
