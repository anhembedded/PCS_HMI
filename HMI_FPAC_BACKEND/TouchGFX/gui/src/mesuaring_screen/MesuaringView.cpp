...
inline void MesuaringView::buttonDigiOut1Handle()
{

    if (buttonDigiOut2.getState())
    {
        buttonDigiOut2.forceState(0);
        buttonDigiOut2.invalidate();
    }
    if (buttonDigiOut3.getState())
    {
        buttonDigiOut3.forceState(0);
        buttonDigiOut3.invalidate();
    }
    if (buttonAnalogOut1.getState())
    {
        buttonAnalogOut1.forceState(0);
        buttonAnalogOut1.invalidate();
    }
    if (buttonAnalogOut2.getState())
    {
        buttonAnalogOut2.forceState(0);
        buttonAnalogOut2.invalidate();
    }
}

inline void MesuaringView::buttonDigiOut2Handle()
{
    if (buttonDigiOut1.getState())
    {
        buttonDigiOut1.forceState(0);
        buttonDigiOut1.invalidate();
    }
    if (buttonDigiOut3.getState())
    {
        buttonDigiOut3.forceState(0);
...
inline void MesuaringView::buttonDigiOut3Handle()
{
    if (buttonDigiOut2.getState())
    {
        buttonDigiOut2.forceState(0);
...
inline void MesuaringView::buttonAnalogOut1Handle()
{
    if (buttonDigiOut2.getState())
    {
        buttonDigiOut2.forceState(0);
...
inline void MesuaringView::buttonAnalogOut2Handle()
{
    if (buttonDigiOut2.getState())
    {
        buttonDigiOut2.forceState(0);
